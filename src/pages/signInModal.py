...
class SignInModal(CommonActions):
    ...
    def clear_sms_code(self):
        CommonActions.set_locator(self, sign_in_lcs["1input_number_fld"]).clear()
        CommonActions.set_locator(self, sign_in_lcs["2input_number_fld"]).clear()
        CommonActions.set_locator(self, sign_in_lcs["3input_number_fld"]).clear()
        CommonActions.set_locator(self, sign_in_lcs["4input_number_fld"]).clear()
        CommonActions.set_locator(self, sign_in_lcs["5input_number_fld"]).clear()
    ...
    def resent_msg_btn(self):
        CommonActions.click_on_visible_locator_ac(self, sign_in_lcs["resent_msg_btn"])
    def sign_in(self):
        wdw(self.driver, 5).until(ec.visibility_of_element_located((By.XPATH, '//*[@id="root"]/div/div[4]/div/div/div/div[3]/div[1]'))).click()
        ...
        SignInModal.set_phone_num(self, "0552603210")
