...
payments_mthds_lcs["b2b"] = (By.CSS_SELECTOR, "#root > div > div.pages_pages > div.pages_children.false > div > div.checkout_checkout > div > div.steps_steps.checkout_steps > form > section:nth-child(1) > div:nth-child(6) > div > label:nth-child(4)")
...
payments_mthds_lcs["purchase"] = (By.CSS_SELECTOR, "#root > div > div.pages_pages > div.pages_children.false > div > div.checkout_checkout > div > div.steps_steps.checkout_steps > form > section:nth-child(2) > div:nth-child(3) > button > input[type=submit]")
...
# asserts
payments_mthds_lcs["trado_modal_open"] = (By.CSS_SELECTOR, "body > div.MuiDialog-root.MuiModal-root.css-126xj0f > div.MuiDialog-container.MuiDialog-scrollPaper.css-ekeie0")
payments_mthds_lcs["order_number"] = (By.CSS_SELECTOR, "#root > div > div.pages_pages > div.pages_children.false > div > div.checkout_checkout > div > h5")
payments_mthds_lcs[""] = (By.CSS_SELECTOR, "")
