...
cart_bar_lcs["product_price_in_div"] = (By.CSS_SELECTOR, "#root > div > div.pages_pages > div.pages_children.false > div > div > div.fullProduct_fullProduct > div > div.fullProduct_more_info > div.cart_cart.cart_cart_checkout.undefined.cart_open > div.cart_list.cart_list_fullProduct > div > a > div > div:nth-child(3) > div:nth-child(1) > div > div > div > span > span")
cart_bar_lcs["product_price_in_footer"] = (By.CSS_SELECTOR, "#root > div > div.pages_pages > div.pages_children.false > div > div > div.fullProduct_fullProduct > div > div.fullProduct_more_info > div.cart_cart.cart_cart_checkout.undefined.cart_open > div.cart_footer.cart_footer_fullProduct > div > h6:nth-child(1) > span:nth-child(2)")
