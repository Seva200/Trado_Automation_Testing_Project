...
class TestHomePage(ChromeDriverSetUp):
    # Header
    @allure.description("Test that verify if user can back into home page after click on logo buttton")
    ...
    @allure.description("test of verify that user can't search invalid item ")
    ...
    @allure.description("test of verify that user can open the personal area page ")
    ...
    @allure.description("test of verify that user can open the personal area page, after he click on the logo button ")
    ...
    @allure.description(
        "test that verify if sales section button works and button title is the same page title that he open")
    ...
    @allure.description(
        "test that verify if dry products section button works and button title is the same page title that he open")
    ...
    @allure.description(
        "test that verify if beauty section button works and button title is the same page title that he open")
    ...
    @allure.description(
        "test that verify if sweet and snacks section button works and button title is the same page title that he open")
    ...
    @allure.description(
        "test that verify if frozen section button works and button title is the same page title that he open")
    def test_frozen_btn(self, driver):
        assert self.common_actions.get_attribute_by_textcontent(home_lcs["page_title"]) == "קפואים"

    @allure.description(
        "test that verify if cannabis section button works and button title is the same page title that he open")
    ...
    @allure.description(
        "test that verify if cleaners section button works and button title is the same page title that he open")
    ...
    @allure.description(
        "test that verify if drinks section button works and button title is the same page title that he open")
    ...
    @allure.description(
        "test that verify if upload product button works and button title is the same page title that he open")
    ...
    # Body
    # Slide Show
    @allure.description('test that verify if user can change slide by click on arrow in slide show')
    ...
    @allure.description("test that verify if user can click on 1 slide from slide show")
    ...
    @allure.description("test that verify if user can click on 3 slide from slide show")
    ...
    @allure.description("test that verify if user can click on 8 slide from slide show")
    ...
    @allure.description("test that verify if tell me more link is work")
    ...
    @allure.description("test that verify if user can change the product list view")
    ...
    @allure.description("test that verify if max card link is work")
    def test_max_card_link(self, driver):
        self.welcome_to_modal.choose_coktails()
        self.home_page.max_card_link_click()
        assert driver.current_url == "https://www.max.co.il/cards/card/8649"

    @allure.description("test that verify if common questions link is work")
    ...
    @allure.description("test that verify if contuct us link is work")
    ...
    @allure.description("test that verify if how shipment works link is work")
    ...
    # Footer
    # Importants
    @allure.description("test that verify if who we are link is work")
    ...
    @allure.description("test that verify if personal area link is work")
    ...
    # Stay in Touch
    @allure.description("test that verify if facebook link is work")
    ...
    @allure.description("test that verify if instagram link is work")
    ...
    @allure.description("test that verify if twitter link is work")
    ...
    @allure.description("test that verify if term of use link is work")
    ...
    @allure.description("test that verify if privacy policy link is work")
    ...
    @allure.description("test that verify if accessibility statement link is work")
