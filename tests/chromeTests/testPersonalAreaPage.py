...
class TestPersonalAreaPage(ChromeDriverSetUp):
    @allure.description("test that verify if user can edit his profile with valid data")
    def test_valid_personal_area(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('Josh', 'Gray', '0552603210', 'joshgrey89@mail.com', '123456789',
                                                   'Paris Baget', '29')
    ...
    @allure.description("test verify that user can't edit his profile with invalid street number")
    ...
    @allure.description("test verify that user can't edit his profile with invalid email")
    def test_invalid_email(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('Josh', 'Gray', '0552992023', 'adaddem', '123456789', 'Paris Baget',
                                                   '29')
        assert self.common_actions.get_attribute_by_textcontent(
            personal_area_lcs["invalid_email_msg"]) == "דוא״ל לא תקין"
    @allure.description("test verify that user can't edit his profile with invalid first name")
    def test_invalid_first_name(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('', 'Gray', '0552603210', 'joshgrey89@mail.com', '123456789',
                                                   'Paris Baget', '29')
        assert self.common_actions.get_attribute_by_textcontent(personal_area_lcs["fname_inv_msg"]) == "נא למלא שדה זה"
    @allure.description("test verify that user can't edit his profile with invalid last name")
    def test_invalid_last_name(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('Josh', '', '0552603210', 'joshgrey89@mail.com', '123456789',
                                                   'Paris Baget', '29')
        assert self.common_actions.get_attribute_by_textcontent(personal_area_lcs["lname_inv_msg"]) == "נא למלא שדה זה"
    @allure.description("test verify that user can't edit his profile with invalid business number")
    ...
    def test_invalid_business_num2(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('Josh', 'Gray', '0552603210', 'joshgrey89@mail.com', '12345678987',
                                                   'Paris Baget', '29')
        assert self.common_actions.get_attribute_by_textcontent(personal_area_lcs["inv_bn_msg"]) == "ח.פ לא תקין"
    @allure.description("test that verify if we are here link is work")
    ...
    @allure.description("test that verify if withdraw button is work")
