...
class TestPersonalAreaPage(ChromeDriverSetUp):
    ...
    def test_invalid_email(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('Josh', 'Gray', '0552992023', 'adaddem', '12345678999', 'Paris Baget',
                                                   '29')
        assert self.common_actions.get_attribute_by_textcontent(
    ...
    def test_invalid_first_name(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('', 'Gray', '0552603210', 'joshgrey89@mail.com', '12345678999',
                                                   'Paris Baget', '29')
    ...
    def test_invalid_last_name(self, driver):
        self.sign_in_modal.sign_in()
        self.home_page.personal_area_hdr_click()
        self.personal_area_page.edit_personal_area('Josh', '', '0552603210', 'joshgrey89@mail.com', '12345678999',
                                                   'Paris Baget', '29')
