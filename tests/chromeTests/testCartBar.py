...
class TestCartBar(ChromeDriverSetUp):
    @allure.description("the test, that verify if item was added to cart after user click on plus button")
    ...
    @allure.description("the test, that verify if added to cart item is the same item in the product page")
    ...
    @allure.description("the test, that verify if user can add some amount of items to cart")
    ...
    @allure.description("the test, that verify if user can decrease some amount of items in the cart")
