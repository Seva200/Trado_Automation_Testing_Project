...
class TestCheckoutProcess(EdgeDriverSetUp):
    @allure.description("the test is verify, if user can proceed a purchase,"
                        " when he has set a valid delivery details data")
    def test_proceed_purchase_with_valid_data(self, driver):
        ...
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
    ...
    def test_proceed_purchase_with_invalid_bn_name1(self, driver):
        ...
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["deliv_details_status"]) \
               == "orderTimeline_time orderTimeline_current orderTimeline_current "
        self.delivery_details_section.set_bn_name('')
        assert self.common_actions.get_attribute_by_textcontent(
            deli_dtls_lcs["invalid_bn_name_msg"]) == " נא למלא שדה זה "
        self.delivery_details_section.complete_purchase_btn_click()
        sleep(1)
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["payments_methods_status"]) \
               != "orderTimeline_time orderTimeline_current orderTimeline_current "
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he has set invalid business name in delivery details")
    def test_proceed_purchase_with_invalid_bn_name2(self, driver):
        ...
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["deliv_details_status"]) \
               == "orderTimeline_time orderTimeline_current orderTimeline_current "
        self.delivery_details_section.set_invoice_details("---", "987654321", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
        assert self.common_actions.get_attribute_by_textcontent(
    ...
    @allure.description("the test is verify,that user can't proceed a purchase,"
                        " when he hasn't set a business number in delivery details")
    def test_proceed_purchase_with_invalid_bn_number1(self, driver):
        ...
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["deliv_details_status"]) \
               == "orderTimeline_time orderTimeline_current orderTimeline_current "
        assert self.common_actions.get_attribute_by_value(deli_dtls_lcs["bn_num_fld"]) == "987654321"
        self.delivery_details_section.set_invoice_details("Pizza Jon", "", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
        assert self.common_actions.get_attribute_by_textcontent(
            deli_dtls_lcs["invalid_bn_num_msg"]) == " נא למלא שדה זה "
        self.delivery_details_section.complete_purchase_btn_click()
        sleep(1)
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["payments_methods_status"]) \
               != "orderTimeline_time orderTimeline_current orderTimeline_current "
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he has set invalid business number in delivery details")
    def test_proceed_purchase_with_invalid_bn_number2(self, driver):
        ...
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["deliv_details_status"]) \
               == "orderTimeline_time orderTimeline_current orderTimeline_current "
        assert self.common_actions.get_attribute_by_value(deli_dtls_lcs["bn_num_fld"]) == "987654321"
        self.delivery_details_section.set_invoice_details("Pizza Jon", "2" * 10, "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he hasn't set an email in delivery details")
    def test_proceed_purchase_with_invalid_email1(self, driver):
        ...
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["deliv_details_status"]) \
               == "orderTimeline_time orderTimeline_current orderTimeline_current "
        assert self.common_actions.get_attribute_by_value(deli_dtls_lcs["bn_num_fld"]) == "987654321"
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "", "Paris",
                                                       "Baget", "3", "a", "2")
        assert self.common_actions.get_attribute_by_textcontent(
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he has set invalid email in delivery details")
    def test_proceed_purchase_with_invalid_email2(self, driver):
        ...
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["deliv_details_status"]) \
               == "orderTimeline_time orderTimeline_current orderTimeline_current "
        assert self.common_actions.get_attribute_by_value(deli_dtls_lcs["bn_num_fld"]) == "987654321"
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "wwqwed34", "Paris",
                                                       "Baget", "3", "a", "2")
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he hasn't set a city name in delivery details")
    def test_proceed_purchase_with_invalid_city1(self, driver):
        ...
        assert self.common_actions.get_attribute_by_class(deli_dtls_lcs["deliv_details_status"]) \
               == "orderTimeline_time orderTimeline_current orderTimeline_current "
        assert self.common_actions.get_attribute_by_value(deli_dtls_lcs["bn_num_fld"]) == "987654321"
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "jhongrey89@mail.com", "",
                                                       "Baget", "3", "a", "2")
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he hasn't set a street name in delivery details")
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he hasn't set an entrance in delivery details")
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he hasn't set a floor number in delivery details")
    ...
    @allure.description("the test is verify, that user can't proceed a purchase,"
                        " when he has set invalid floor number in delivery details")
    ...
    @allure.description("the test is verify, if user can execute purchase with valid credit card")
    def test_execute_valid_credit_card_purchase(self, driver):
        ...
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
        self.delivery_details_section.complete_purchase_btn_click()
        self.payments_methods_section.credit_card_click()
    ...
    @allure.description("the test is verify, that user can't execute purchase with invalid credit card")
    def test_execute_invalid_credit_card_purchase(self, driver):
        ...
        self.credit_card_modal.set_id_num("000000000")
        assert self.common_actions.get_attribute_by_textcontent(
            credit_card_lcs["invalid_card_number_msg"]) == "מספר כרטיס אשראי אינו תקין (418)"
        self.credit_card_modal.submit_btn_click()
        driver.switch_to.parent_frame()
        assert self.common_actions.get_attribute_by_class(
            home_lcs["modal_open"]) == "modal_modalWrapper false modal_open    "

    @allure.description("the test is verify, that user can't execute a purchase without choose payment method ")
    ...
    @allure.description("the test is verify, that user can't execute a purchase with invalid bank transfer data ")
    def test_execute_invalid_purchase2(self, driver):
        ...
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
        self.delivery_details_section.complete_purchase_btn_click()
        self.payments_methods_section.bank_transfer_click()
        self.bank_transfer_modal.set_bank_branch("dshdj")
    ...
    @allure.description("the test is verify, that user can't execute a purchase with invalid finTrado data ")
    def test_execute_invalid_purchase3(self, driver):
        ...
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
        self.delivery_details_section.complete_purchase_btn_click()
        self.payments_methods_section.fin_trado_click()
        assert self.common_actions.get_attribute_by_class(
            payments_mthds_lcs["trado_modal_open"]) == "MuiDialog-container MuiDialog-scrollPaper css-ekeie0"
    ...
    @allure.description("the test is verify, that user can't execute a purchase with invalid digital check data ")
    def test_execute_invalid_purchase4(self, driver):
        ...
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
        self.delivery_details_section.complete_purchase_btn_click()
        self.payments_methods_section.digital_check_click()
        assert self.common_actions.get_attribute_by_class(
            home_lcs["modal_open"]) == "modal_modalWrapper false modal_open    "
    ...
    @allure.description("the test is verify, that user can't execute a purchase with invalid b2b data ")
    def test_execute_invalid_purchase5(self, driver):
        ...
        self.delivery_details_section.set_invoice_details("Pizza Jon", "987654321", "jhongrey89@mail.com", "Paris",
                                                       "Baget", "3", "a", "2")
        self.delivery_details_section.complete_purchase_btn_click()
        self.payments_methods_section.b2b_click()
        assert self.common_actions.get_attribute_by_class(
            home_lcs["modal_open"]) == "modal_modalWrapper false modal_open    "
